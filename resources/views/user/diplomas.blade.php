            ...
            <div class="row">
                <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-10 offset-md-1">
                    <div class="breadcrumb-title">
                        <h2>{{trans('diplomas/diplomas.diplomas')}}</h2>
                    ...
                    <div class="team-member ">
                        <div class="team-member-img">
                            @if($diploma->image != null)
                                <img src="{{URL::to('/') . '/Diploma/' . $diploma->title.'/'.$diploma->image}}"
                                    alt="Image">
                            @else
                                <img
                        ...
                        <div class="desc" style="display:none">{!!$diploma->desc!!}</div>
                    </div>
                </div>
            @endforeach
</div> -->
                ...
                @foreach ($diplomas as $diploma)
                    <div class="col-lg-3 col-md-4 col-6 col-sm-6">
                        <div class="team-member ">
                            ...
                            <h4><a class=""
                                   href="{{route('diplomadetails',$diploma->id)}}">{{$diploma->title}}</a></h4>
                                    ...
                                    <div class=" showcourse team-member-info" style="overflow:hidden">
                                        ...
                                        <div class="toggleHolder p-b-1">
                                            <p  class=" descShow toggler-3  btn-toggle-course1">{{trans('enduser/Home/Home.Show More')}}</<p>
                                            <p class="toggler-4 btn-toggle-close">{{trans('enduser/Home/Home.Show Less')}}</<p>
                                         </div>
                        </div>
                    </div>
                @endforeach
