            ...
            <!-- -->
                <div class="box-progress">
                    ...
                    <h3 class="p-t-23 diploma-color text-center">{{trans('students/students.Diploma Name')}} :
                       ...
                       @if((new \App\Helpers\General)->getDiplomaStatus($diploma))
                            <h3 class="p-t-23 diploma-color text-center">
                                <a  href="{{route('student.course.requestcertificate', ['diploma_id'=>$diploma->id])}}"
                                    class=" btn btn-primary text-black">{{trans('students/students.stage')}}</a>
                            </h3>
