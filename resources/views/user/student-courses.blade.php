            ...
            <div class="row">
                <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-10 offset-md-1">
                    <div class="breadcrumb-title">
                        <h2>{{trans('courses/courses.Your Courses')}}</h2>
                    ...
                    @foreach ($courses as $course)
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="team-member m-r-34">
                                <div class="team-member-img" style="height:300px">
                                    @isset($course->image)
                                ...
                                <div class="team-member-info">
                                    <h4><a href="{{route('coursedetails',$course->id)}}">{!!$course->title!!}</a></h4>
                                ...
                                <div class="toggleHolder p-b-1">
                                    <button
                                        class=" descShow toggler-3 btn btn-toggle">{{trans('enduser/Home/Home.Show More')}}</button>
                                    <button
                                        class="toggler-4 btn btn-toggle-close">{{trans('enduser/Home/Home.Show Less')}}</button>
                                </div>
                            </div>
                        </div>
                    @endforeach
