...
@section('title',trans('surveys/surveys.survey_questions'))
            ...
            <div class="row">
                <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-10 offset-md-1">
                    <div class="breadcrumb-title">
                        <h2>{{trans('surveys/surveys.survey_questions')}}</h2>

                        <ul class="breadcrumb-menu">
                            <li><a href="{{route('site.home')}}">Home </a></li>
                            <li><a href="{{route('student.survay')}}">{{trans('surveys/surveys.surveys')}} </a></li>
                            <li><a href="{{route('student.survayD', $survay->id)}}">{{$survay->title}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="ecour-faq">
                        @if(!empty($questions->toArray()))
                            <form method="POST" action="{{route('student.survay.apply_survay', $survay->id)}}"
                                ...
                                <div class="accordion" id="accordionExample">
                                    ...
                                    @endforeach
                                    <div>
                                        <button type="submit" class="save">{{ trans('general.Save') }}</button>
                                    </div>
                                </div>
                        ...
                        @else
                            ...
                            <div>
                                <p class="badge bg-danger"> {{ trans('surveys/surveys.no_questions') }}</p>
                            </div>
