        ...
        <div class="my-auto">
                    <div class="d-flex">
                            <h4 class="content-title mb-0 my-auto f-z-30"><a href="{{route('lecture.index')}}" class="text-dark">{{trans('lectures/lectures.lectures')}}</a></h4><span
                                class="text-muted mt-1 tx-13 ms-2 mb-0"> / <a href="{{route('lecture.create')}}"> {{trans('lectures/lectures.add_lecture')}}</a></span>
                        </div>
        </div>
    </div>    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('lecture.store')}}" method="POST"
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="col-sm-12 col-lg-6 col-md-12">
                                <p class="mg-b-10 mr-3 f-z-18">{{trans('lectures/lectures.type')}} <span class="tx-danger">*</span></p>
                                <select name="type" id="type" required="" class="form-control select2  select2-type">
                                    <option >
                        ...
                        <div class="row row-sm mt-2">
                            <div class="col-lg-12 mg-t-20 mg-lg-t-0">
                                <p class="mg-b-10 f-z-18">{{trans('lectures/lectures.course')}} <span class="tx-danger">*</span></p>
...
{{--                            <div class="col-sm-12 col-lg-6 col-md-12">--}}
{{--                                <p class="mg-b-10 f-z-18">{{trans('lectures/lectures.teacher')}} <span class="tx-danger">*</span></p>--}}
