        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto f-z-30"><a href="{{route('diploma.index')}}" class="text-dark">{{trans('diplomas/diplomas.diplomas')}}</a></h4><span
                    class="text-muted mt-1 tx-13 ms-2 mb-0"> / <a href="{{route('diploma.edit',$diploma->id)}}">{{trans('diplomas/diplomas.edit_diploma')}}</a></span>
            </div>
        </div>
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="col-12">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" name="title_en" value="{{ $diploma->title }}" placeholder="{{trans('diplomas/diplomas.plc_title')}}" required="" type="text">
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div>
                                        <input type="file"  name="image" id="file"
                                               ...
                                               data-default-file="{{URL::to('/') . '/Diploma/' . $diploma->title.'/'.$diploma->image}}"
                                        /></div>
                                </div>
                            </div>
...
{{--                                    <img--}}
{{--                                        src="{{URL::to('/') . '/Diploma/' . $diploma->title.'/'.$diploma->image}}"--}}
