    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            ...
            <h4 class="content-title mb-0 my-auto f-z-30"><a href="{{route('homework.index')}}" class="text-dark">{{trans('Homework/Homework.Homeworks')}}</a></h4>
                <span class="text-muted mt-1 tx-13 ms-2 mb-0"> /{{trans('Homework/Homework.Add Files')}}</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="pull-right">
                        <a class="btn blue-button mb-15 btn-sm" href="{{ route('homework.index') }}"> {{trans('Homework/Homework.Back')}}</a>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <form method="" action=""
                                    ...
                                    <div class="form-group">
                                        <label for="RePassword f-z-18">{{trans('Homework/Homework.name')}}</label>
