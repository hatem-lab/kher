    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            ...
            <h4 class="content-title mb-0 my-auto f-z-30"><a href="{{route('homework.index')}}" class="text-dark">{{trans('Homework/Homework.Homeworks')}}</a></h4>
                <span class="text-muted mt-1 tx-13 ms-2 mb-0"> / <a href="{{route('homework.create')}}">{{trans('Homework/Homework.add_homework')}}</a></span>
            </div>
        </div>
                    ...
                    <form action="{{route('homework.store')}}" method="POST"
                        ...
                        <div class="row row-sm mg-b-20">
                            <div class="col-lg-12">
                                <div class="form-group mg-b-0">
                                    <label class="form-label f-z-18">{{trans('lectures/lectures.title')}}: <span class="tx-danger">*</span></label>
                        ...
                        <div class="row row-sm">
                            <div class="col-xs-12 col-md-12">
                                <div class="form-group mg-b-0">
                                    <label class="form-label f-z-18">{{trans('Homework/Homework.mark')}}: <span class="tx-danger">*</span></label>
                                    <input class="form-control" name="mark" placeholder="{{trans('Homework/Homework.mark')}}" required="" type="text">
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row row-sm mg-b-20">
                            <div class="col-lg-12">
                                <div class="form-group mg-b-0">
                                <label class="form-label f-z-18">{{trans('Homework/Homework.course')}}:<span class="tx-danger">*</span></label>
                                <select name="course_id" required="" id="select-beast" class="form-control  nice-select  custom-select select2">
                        ...
                        <div class="row row-sm">
                            <div class="col-lg-12">
                                <label class="form-label f-z-18">{{trans('Homework/Homework.lectures')}}:<span class="tx-danger">*</span></label>
                                <select name="lecture_id" required="" id="select-beast" class="form-control   nice-select  custom-select select2">
                        ...
                        <div class="row row-sm mg-b-20">
                            <div class="col-lg-12">
                                <label class="form-label f-z-18">{{trans('Homework/Homework.teachers')}}:<span class="tx-danger">*</span></label>
                                <select name="teacher_id" required="" id="select-beast" class="form-control  nice-select  custom-select select2">
                        ...
                        <div class="row mg-b-20">
                            <div class="col-xs-12 col-md-12">
                                <p class="mg-b-10 f-z-18">{{trans('Homework/Homework.students')}} <span class="tx-danger">*</span></p>
                        ...
                        <div class="row row-sm mt-2">
                         ...
                         <div class="row row-sm mt-2">
                            <div class="col-12">
                                <div class="form-group mg-b-0">
                                    <label
                                        class="form-label f-z-18">{{trans('lectures/lectures.desc')}} </label>
