                    ...
                    <form action="{{route('survey.question.store', $survey->id)}}" method="POST"
                        ...
                        <div class="row row-sm mt-2">
                            <div class="col-12">
                                <div class="form-group mg-b-0">
                                    <label
                                        class="form-label f-z-18">{{trans('questions/questions.desc')}} </label>
                        ...
                        <div class="row row-sm mt-2">
                            <div class="col-lg-6 mg-t-20 mg-lg-t-0">
                                <p class="mg-b-10 f-z-18">{{trans('questions/questions.type')}} <span
                        ...
                        <div class="row row-sm mt-2" id="option_div">
                                    ...
                                    <div data-repeater-item>
                                        <div class="row d-flex align-items-end">
                                            <div class="col-md-4 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label f-z-18" for="itemname">{{trans('questions/questions.option')}}</label>
                                                    <input
                                                        type="text"
                                                        class="form-control"
                                                        name="option"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button class="btn blue-button mb-15" type="button" data-repeater-create>
