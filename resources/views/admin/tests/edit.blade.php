    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            ...
            <h4 class="content-title mb-0 my-auto f-z-30"> <a href="{{route('test.index')}}" class="text-dark">{{trans('tests/tests.tests')}}</a></h4>
                <span class="text-muted mt-1 tx-13 ms-2 mb-0">/ {{$test->title}}
                </span>
                <span
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('test.update', $test->id)}}" method="POST"
                        ...
                        <div class="row row-sm mt-2">
                                ...
                                <div class="col-12 ">
                                    <label class="form-label mt-12 f-z-18">{{trans('tests/tests.duration')}}: <span class="tx-danger star-span">*</span></label>
                        ...
                        <div class="row row-sm mt-2">
                            ...
                            <div class="col-12">
                                <label class="form-label mt-12 f-z-18">{{trans('tests/tests.weight')}}: </label>
                        ...
                        <div class="row row-sm mt-2">
                                    <div class="col-12">
                                            <div class="form-group mg-b-0">
                                                    <label class="form-label f-z-18">{{trans('tests/tests.desc')}} </label>
