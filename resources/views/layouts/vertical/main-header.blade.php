        ...
        <div class="main-header-left ">
            <div class="responsive-logo">
                ...
                <a href="{{url('index')}}"><img src="{{asset('assets/img/brand/logo-white.png')}}" class="dark-logo-1"
                                                alt="logo"></a>
                <a href="{{url('admin/home')}}"><img src="{{asset('assets/img/brand/logo-2.png')}}" class="logo-2"
                                                alt="logo"></a>
        ...
        <div class="main-header-right">
            <ul class="nav nav-item  navbar-nav-right ms-auto">
                ...
                <li class="dropdown nav-item main-header-notification">
                    <a class="new nav-link" href="javascript:void(0);" id="not_btn">
                        {{--                                    <span class="badge rounded-pill bg-danger badge-up" id="num_out"><span id="num"></span></span>--}}
                        ...
                        <span class=" pulse" id="point_out"></span>
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="menu-header-content bg-primary text-start">
                            <div class="d-flex">
                                <h6 class="dropdown-title mb-1 tx-15 text-white fw-semibold">{{trans('general.Notifications')}}
                                </h6>
                                <span class="badge rounded-pill bg-success ms-auto my-auto float-end" id="inner_num_out">
                                    <span
                                        id="inner_num"></span>
                                </span>
                            </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="new_out" >
                                {{trans('general.New')}}
                                </p>
                        </div>
                        <div class="main-notification-list Notification-scroll" id="nots_list">


                        </div>
                        <div class="dropdown-footer">
                            <a href="{{route('admin-my-notifications')}}">{{trans('general.view_all')}}</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                                                                src="{{auth('admin') -> user() -> profile ? URL::to('/') . '/Profile/' . auth('admin') -> user() ->name.'/'.auth('admin') -> user() -> profile->image: URL::to('/') . '/Profile/' .'default.jpg'}}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user">
                                    ...
                                    <img alt=""
                                         src="{{auth('admin') -> user() -> profile ? URL::to('/') . '/Profile/' . auth('admin') -> user() ->name.'/'.auth('admin') -> user() -> profile->image: URL::to('/') . '/Profile/' .'default.jpg'}}"
                                         class="">
                                </div>
                                <div class="ms-3 my-auto">
                                    <h6>{{auth('admin') -> user() -> name}}</h6>
                                    <span>{{App\Helpers\General::roleUser(auth('admin') -> user() -> role) }}</span>
                                </div>

                            </div>
                        </div>
                        <a class="dropdown-item" href="{{url('admin/profile')}}"><i
                                class="bx bx-user-circle"></i>{{trans('general.Profile')}}</a>
